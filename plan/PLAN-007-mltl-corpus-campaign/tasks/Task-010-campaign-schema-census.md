...
relationships:
  ...
  - target: ix://agent-ix/tl-mltl/FR-008
    type: references
  - target: ix://agent-ix/tl-mltl/TC-091
    type: verifies
  - target: ix://agent-ix/tl-mltl/TC-092
    type: verifies
  - target: ix://agent-ix/tl-mltl/TC-095
    type: verifies
---

# Task-010: FR-008 — campaign schema and fail-closed census
...
- TC-091, TC-092, and TC-095 trace-tagged tests.

## Notes

- Blocked until the exact reviewed specification revision is human-accepted
  on issue #38.
