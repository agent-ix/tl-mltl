---
id: MP-008
title: TL Stage 1 V1 independent oracle native result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v1.v1_independent_oracle.passed
definition_version: tl.v1.v1-independent-oracle/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V1.independent_oracle in the five-source Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v1-independent-oracle.json
...
# TL Stage 1 V1 independent oracle native result
...
The exact command and bound response are in `campaign/procedures/v1-independent-oracle.json`. EA runs the command without a shell. Quoin retains its request, raw stdout and stderr, output artifacts, collection, and checker result. The TL Rust checker independently scores the decisive native facts.
