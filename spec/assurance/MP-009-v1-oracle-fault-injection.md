---
id: MP-009
title: TL Stage 1 V1 oracle fault injection native result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v1.v1_oracle_fault_injection.passed
definition_version: tl.v1.v1-oracle-fault-injection/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V1.oracle_fault_injection in the five-source Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v1-oracle-fault-injection.json
...
# TL Stage 1 V1 oracle fault injection native result
...
The exact command and bound response are in `campaign/procedures/v1-oracle-fault-injection.json`. EA runs the command without a shell. Quoin retains its request, raw stdout and stderr, output artifacts, collection, and checker result. The TL Rust checker independently scores the decisive native facts.
