---
id: MP-012
title: TL Stage 1 V1 production infinite faults native result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v1.v1_production_infinite_faults.passed
definition_version: tl.v1.v1-production-infinite-faults/v1
execution_procedure: campaign/procedures/v1-production-infinite-faults.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V1.production_infinite_faults in the five-source Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v1-production-infinite-faults.json
...
# TL Stage 1 V1 production infinite faults native result
...
The exact command and bound response are in `campaign/procedures/v1-production-infinite-faults.json`. EA runs the command without a shell. Quoin retains its request, raw stdout and stderr, output artifacts, collection, and checker result. The TL Rust checker independently scores the decisive native facts.
