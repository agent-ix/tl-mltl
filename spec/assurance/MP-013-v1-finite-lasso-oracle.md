---
id: MP-013
title: TL Stage 1 V1 finite lasso oracle native result
...
The exact command and bound response are in `campaign/procedures/v1-finite-lasso-oracle.json`. EA runs the command without a shell. Quoin retains its request, raw stdout and stderr, output artifacts, collection, and checker result. The TL Rust checker independently scores the decisive native facts.
