---
id: MP-017
title: TL Stage 1 V11 infinite oracle native result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v1.v11_infinite_oracle.passed
definition_version: tl.v1.v11-infinite-oracle/v1
execution_procedure: campaign/procedures/v11-infinite-oracle.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V11.infinite_oracle in the five-source Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v11-infinite-oracle.json
...
# TL Stage 1 V11 infinite oracle native result
...
The exact command and bound response are in `campaign/procedures/v11-infinite-oracle.json`. EA runs the command without a shell. Quoin retains its request, raw stdout and stderr, output artifacts, collection, and checker result. The TL Rust checker independently scores the decisive native facts.
