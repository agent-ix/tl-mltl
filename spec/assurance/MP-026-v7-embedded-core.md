---
id: MP-026
title: TL Stage 1 V7.embedded_core native embedded or Miri result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v7.embedded_core.passed
definition_version: tl.v7.embedded-core/v1
execution_procedure: campaign/procedures/v7-embedded-core.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V7.embedded_core in the five-source Stage 1 campaign
...
# TL Stage 1 V7.embedded_core native embedded or Miri result
...
The direct command and bounded response are in `campaign/procedures/v7-embedded-core.json`. EA executes in a complete exact Git source projection. Quoin retains the request and raw stdout and stderr. The TL Rust checker independently scores the native result.
