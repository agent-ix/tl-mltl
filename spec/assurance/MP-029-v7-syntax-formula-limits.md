---
id: MP-029
title: TL Stage 1 V7.syntax_formula_limits native embedded or Miri result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v7.syntax_formula_limits.passed
definition_version: tl.v7.syntax-formula-limits/v1
execution_procedure: campaign/procedures/v7-syntax-formula-limits.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V7.syntax_formula_limits in the five-source Stage 1 campaign
...
# TL Stage 1 V7.syntax_formula_limits native embedded or Miri result
...
The direct command and bounded response are in `campaign/procedures/v7-syntax-formula-limits.json`. EA executes in a complete exact Git source projection. Quoin retains the request and raw stdout and stderr. The TL Rust checker independently scores the native result.
