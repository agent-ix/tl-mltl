---
id: MP-039
title: TL Stage 1 V6.seeded_false_claim native Kani control
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v6.seeded_false_claim.verified
definition_version: tl.v6.seeded-false-claim/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V6.seeded_false_claim in the five-source Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v6-seeded-false-claim.json
...
# TL Stage 1 V6.seeded_false_claim native Kani control
...
The direct command and bounded response are in `campaign/procedures/v6-seeded-false-claim.json`. EA executes in a complete exact Git source projection. Quoin retains the request and raw stdout and stderr. The TL Rust checker independently scores the Kani output and replay result.
