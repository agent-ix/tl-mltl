---
id: MP-041
title: TL Stage 1 V8.syntax_core native coverage result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v8.syntax_core.verified
definition_version: tl.v8.syntax-core/v1
execution_procedure: campaign/procedures/v8-syntax-core.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V8.syntax_core in the five-source Stage 1 campaign
...
# TL Stage 1 V8.syntax_core native coverage result
