---
id: MP-042
title: TL Stage 1 V8.syntax_alloc native coverage result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v8.syntax_alloc.verified
definition_version: tl.v8.syntax-alloc/v1
execution_procedure: campaign/procedures/v8-syntax-alloc.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V8.syntax_alloc in the five-source Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v8-syntax-alloc.json
...
# TL Stage 1 V8.syntax_alloc native coverage result
