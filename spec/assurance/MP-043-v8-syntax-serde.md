---
id: MP-043
title: TL Stage 1 V8.syntax_serde native coverage result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v8.syntax_serde.verified
definition_version: tl.v8.syntax-serde/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V8.syntax_serde in the five-source Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v8-syntax-serde.json
...
# TL Stage 1 V8.syntax_serde native coverage result
