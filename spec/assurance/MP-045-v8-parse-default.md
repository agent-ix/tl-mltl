---
id: MP-045
title: TL Stage 1 V8.parse_default native coverage result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v8.parse_default.verified
definition_version: tl.v8.parse-default/v1
execution_procedure: campaign/procedures/v8-parse-default.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V8.parse_default in the five-source Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v8-parse-default.json
...
# TL Stage 1 V8.parse_default native coverage result
