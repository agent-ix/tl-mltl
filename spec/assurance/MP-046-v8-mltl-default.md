---
id: MP-046
title: TL Stage 1 V8.mltl_default native coverage result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v8.mltl_default.verified
definition_version: tl.v8.mltl-default/v1
execution_procedure: campaign/procedures/v8-mltl-default.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V8.mltl_default in the five-source Stage 1 campaign
...
# TL Stage 1 V8.mltl_default native coverage result
