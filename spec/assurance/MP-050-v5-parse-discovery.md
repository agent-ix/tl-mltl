---
id: MP-050
title: TL Stage 1 V5 tl-parse discovery native mutation result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v5.parse_discovery.verified
definition_version: tl.v5.parse-discovery/v1
execution_procedure: campaign/procedures/v5-parse-discovery.json
stage: gate
...
# TL Stage 1 V5 tl-parse discovery native mutation result
