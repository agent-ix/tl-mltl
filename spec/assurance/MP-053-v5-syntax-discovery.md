---
id: MP-053
title: TL Stage 1 V5 tl-syntax discovery native mutation result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v5.syntax_discovery.verified
definition_version: tl.v5.syntax-discovery/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native discovery invocation for tl-syntax in the Stage 1 campaign
...
# TL Stage 1 V5 tl-syntax discovery native mutation result
