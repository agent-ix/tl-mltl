---
id: MP-054
title: TL Stage 1 V5 tl-syntax mutation native mutation result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v5.syntax_mutation.verified
definition_version: tl.v5.syntax-mutation/v1
execution_procedure: campaign/procedures/v5-syntax-mutation.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native mutation invocation for tl-syntax in the Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v5-syntax-mutation.json
...
# TL Stage 1 V5 tl-syntax mutation native mutation result
