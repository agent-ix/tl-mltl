---
id: MP-058
title: TL Stage 1 V5 tl-mltl restored-control native mutation result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v5.mltl_restored_control.verified
definition_version: tl.v5.mltl-restored-control/v1
execution_procedure: campaign/procedures/v5-mltl-restored-control.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native restored-control invocation for tl-mltl in the Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v5-mltl-restored-control.json
...
# TL Stage 1 V5 tl-mltl restored-control native mutation result
