---
id: MP-061
title: TL Stage 1 V5 tl-rewrite restored-control native mutation result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v5.rewrite_restored_control.verified
definition_version: tl.v5.rewrite-restored-control/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native restored-control invocation for tl-rewrite in the Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v5-rewrite-restored-control.json
...
# TL Stage 1 V5 tl-rewrite restored-control native mutation result
