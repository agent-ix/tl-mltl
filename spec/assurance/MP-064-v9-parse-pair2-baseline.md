---
id: MP-064
title: TL Stage 1 V9 parse pair 2 baseline Criterion result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v9.parse_pair2_baseline.verified
definition_version: tl.v9.parse-pair2-baseline/v1
execution_procedure: campaign/procedures/v9-parse-pair2-baseline.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct Criterion invocation for V9.parse_pair2_baseline in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v9-parse-pair2-baseline.json
...
# TL Stage 1 V9 parse pair 2 baseline Criterion result
