---
id: MP-067
title: TL Stage 1 V9 rewrite pair 1 candidate Criterion result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v9.rewrite_pair1_candidate.verified
definition_version: tl.v9.rewrite-pair1-candidate/v1
execution_procedure: campaign/procedures/v9-rewrite-pair1-candidate.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct Criterion invocation for V9.rewrite_pair1_candidate in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v9-rewrite-pair1-candidate.json
...
# TL Stage 1 V9 rewrite pair 1 candidate Criterion result
