---
id: MP-072
title: TL Stage 1 V9 mltl pair 2 baseline Criterion result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v9.mltl_pair2_baseline.verified
definition_version: tl.v9.mltl-pair2-baseline/v1
execution_procedure: campaign/procedures/v9-mltl-pair2-baseline.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct Criterion invocation for V9.mltl_pair2_baseline in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v9-mltl-pair2-baseline.json
...
# TL Stage 1 V9 mltl pair 2 baseline Criterion result
