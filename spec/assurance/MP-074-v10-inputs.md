---
id: MP-074
title: TL Stage 1 V10.inputs direct foreign result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v10.inputs.verified
definition_version: tl.v10.inputs/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.inputs in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-inputs.json
...
# TL Stage 1 V10.inputs direct foreign result

## Decision Use

This required V10 member is interpreted only from its retained native result and independently checked raw facts. The generated manifest declares 225 formula-trace cases and 1,350 positions. The campaign combines every required member with `all-required`.
