---
id: MP-075
title: TL Stage 1 V10.compile.zero-singleton-all-true direct foreign result
...
execution_procedure: campaign/procedures/v10-compile-zero-singleton-all-true.json
stage: gate
...
# TL Stage 1 V10.compile.zero-singleton-all-true direct foreign result
