---
id: MP-091
title: TL Stage 1 V10.compile.zero-upper-boundary-toggle direct foreign result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v10.compile_zero_upper_boundary_toggle.verified
definition_version: tl.v10.compile-zero-upper-boundary-toggle/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.compile.zero-upper-boundary-toggle in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-compile-zero-upper-boundary-toggle.json
...
# TL Stage 1 V10.compile.zero-upper-boundary-toggle direct foreign result
