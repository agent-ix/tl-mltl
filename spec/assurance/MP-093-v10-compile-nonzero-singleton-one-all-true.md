---
id: MP-093
title: TL Stage 1 V10.compile.nonzero-singleton-one-all-true direct foreign result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v10.compile_nonzero_singleton_one_all_true.verified
definition_version: tl.v10.compile-nonzero-singleton-one-all-true/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.compile.nonzero-singleton-one-all-true in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-compile-nonzero-singleton-one-all-true.json
...
# TL Stage 1 V10.compile.nonzero-singleton-one-all-true direct foreign result
