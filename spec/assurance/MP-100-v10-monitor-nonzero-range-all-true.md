---
id: MP-100
title: TL Stage 1 V10.monitor.nonzero-range-all-true direct foreign result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v10.monitor_nonzero_range_all_true.verified
definition_version: tl.v10.monitor-nonzero-range-all-true/v1
execution_procedure: campaign/procedures/v10-monitor-nonzero-range-all-true.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.monitor.nonzero-range-all-true in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-monitor-nonzero-range-all-true.json
...
# TL Stage 1 V10.monitor.nonzero-range-all-true direct foreign result
