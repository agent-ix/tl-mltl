---
id: MP-106
title: TL Stage 1 V10.monitor.nonzero-singleton-all-true direct foreign result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v10.monitor_nonzero_singleton_all_true.verified
definition_version: tl.v10.monitor-nonzero-singleton-all-true/v1
execution_procedure: campaign/procedures/v10-monitor-nonzero-singleton-all-true.json
stage: gate
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.monitor.nonzero-singleton-all-true in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-monitor-nonzero-singleton-all-true.json
...
# TL Stage 1 V10.monitor.nonzero-singleton-all-true direct foreign result
