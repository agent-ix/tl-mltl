---
id: MP-108
title: TL Stage 1 V10.monitor.nonzero-singleton-all-false direct foreign result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v10.monitor_nonzero_singleton_all_false.verified
definition_version: tl.v10.monitor-nonzero-singleton-all-false/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.monitor.nonzero-singleton-all-false in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-monitor-nonzero-singleton-all-false.json
...
# TL Stage 1 V10.monitor.nonzero-singleton-all-false direct foreign result
