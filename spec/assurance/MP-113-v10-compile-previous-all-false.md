---
id: MP-113
title: TL Stage 1 V10.compile.previous-all-false direct foreign result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v10.compile_previous_all_false.verified
definition_version: tl.v10.compile-previous-all-false/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.compile.previous-all-false in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-compile-previous-all-false.json
...
# TL Stage 1 V10.compile.previous-all-false direct foreign result
