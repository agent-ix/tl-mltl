---
id: MP-116
title: TL Stage 1 V10.monitor.previous-boundary-toggle direct foreign result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v10.monitor_previous_boundary_toggle.verified
definition_version: tl.v10.monitor-previous-boundary-toggle/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.monitor.previous-boundary-toggle in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-monitor-previous-boundary-toggle.json
...
# TL Stage 1 V10.monitor.previous-boundary-toggle direct foreign result
