---
id: MP-120
title: TL Stage 1 V10.monitor.past direct foreign result
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.monitor.past in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-monitor-past.json
...
# TL Stage 1 V10.monitor.past direct foreign result
