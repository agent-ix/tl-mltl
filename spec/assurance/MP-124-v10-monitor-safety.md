---
id: MP-124
title: TL Stage 1 V10.monitor.safety direct foreign result
type: MeasurementPlan
status: active
owner: tl-mltl-evidence-owner
metric: tl.v10.monitor_safety.verified
definition_version: tl.v10.monitor-safety/v1
...
objective:
  ...
  bound: 1
statistical_design:
  population: one exact direct native invocation for V10.monitor.safety in the source-bound Stage 1 campaign
  ...
  decision_rule:
    ...
    threshold: 1
protected_apparatus:
  - campaign/procedures/v10-monitor-safety.json
...
# TL Stage 1 V10.monitor.safety direct foreign result
