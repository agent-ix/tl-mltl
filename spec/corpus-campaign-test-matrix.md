...
| W/M canonical lowering | TC-042 | TC-047 | TC-044 | accepted tl-syntax #37 |
...
|---|---|---|---|---|---|
| TC-037 | Strictly round-trip the closed campaign, dimension, and coverage-cell schemas and refuse duplicate, omitted, unknown, or contradictory entries | Integration | P0 | FR-008-AC-1 | 🚧 planned |
| TC-038 | Enumerate every dimension tuple exactly once as applicable, excluded, or blocked and mutation-test each census status | Property | P0 | FR-008-AC-1, FR-008-AC-2 | 🚧 planned |
...
| TC-044 | Strictly round-trip every v1 fixture family; verify one owner plus exact consumer revision, manifest digest, license, provenance, oracle, and limitation fields; and reject unsafe paths and resource bounds | Integration | P0 | FR-009-AC-1, FR-009-AC-2, FR-009-AC-6 | 🚧 planned |
...
| TC-046 | Round-trip loss, availability, and comparison axes; preserve every non-conclusive state; and verify target claims without executing a foreign runtime | Integration | P0 | FR-010-AC-1, FR-010-AC-2, FR-010-AC-3, FR-010-AC-4, FR-010-AC-5, NFR-004-AC-3 | 🚧 planned |
...
| TC-048 | Run the repository-ownership and executable-dependency gate over every routed implementation ticket, rejecting a foreign runtime or new local evidence/retention framework | Integration | P0 | FR-009-AC-2, FR-009-AC-5, FR-010-AC-2 | 🚧 planned |
