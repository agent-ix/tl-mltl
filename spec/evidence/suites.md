...
| SUITE-002 | Specification validation | `quire validate --scope . 'spec/**/*.md'` | quire-cli 0.33.0 | Analysis |
| SUITE-003 | Requirement coverage export | `quire coverage --scope . --json` | quire-cli 0.33.0 | Analysis |
...
| SUITE-009 | Shared pin classification | `python3 scripts/check_shared_pins.py` | engineering-assurance 0.4.1 native classifier | Analysis |
