...
Implementation statuses below reflect only traced, executable tests. Rows
requiring broader qualification remain planned.
...
| FR-042 | FR-042-AC-1 through FR-042-AC-2 | TC-164, TC-174 | ✅ implemented |
...
| TC-163 | Compare pinned bounded future v1/v2 behavioral payloads and the pre/post past-mapping legacy renderer; keep version/source identities bound to actual pins | Snapshot | P0 | FR-038-AC-2 | ✅ implemented |
...
| TC-165 | Exercise H/O/S/Y/T at zero and adjacent positions under the source false-before-origin rule | Property | P0 | FR-039-AC-1 | ✅ implemented |
...
| TC-174 | Verify corpus digest/provenance and drive the strict reader plus real c2po_map entry point under recorded fuzz seed and budget | Fuzz | P0 | FR-042-AC-1, FR-042-AC-2 | ✅ implemented |
