...
- Exact capability, TL profile, graph, clock, fairness and trace identities.
...
only the opt-in module. Another registrant for the same deployment is a
...
| FR-028-AC-2 | Two registrants or an exact-identity mismatch refuse without routing to a bounded evaluator or returning a partial result. | Test (TC-139) |
