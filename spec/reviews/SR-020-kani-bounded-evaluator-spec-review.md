...
| FND-2005 | low | Adding SR-020/SR-021 to the tracked specification population exposes the existing TC-024 census deliberately. Update its per-area and total controls together (spec 64→67, tests 16→17, total 140→144); do not weaken or bypass the census. | NFR-003-AC-1, TC-024, tests/shared_assurance.rs |
