...
| FND-3713 | high | **FIXED during cross-lane remediation after review of `bbdb93e`:** `2>&1` was split at `&` before command discovery could recognize the declared `>&` redirection. The tokenizer now retains fd-duplication operators and TC-036 names an alternate after that prefix. | NFR-003-AC-5, TC-036, tests/shared_assurance.rs, tl-rewrite#34 review |
