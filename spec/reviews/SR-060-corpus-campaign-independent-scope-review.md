...
| FND-6003 | medium | Native bridge work could leak source grammar, predicate, or clock/history semantics into tl-mltl. Retained owner boundary: Task-023 consumes exact #63/#64 families only and cannot define a fallback. | MRS-002, Task-023 |
| FND-6004 | low | External runtimes remain unavailable/unsupported inputs, never executable dependencies or semantic authorities. | FR-010, Task-021 |
...
|---|---|---|
| landed TL future/W/M revisions | guaranteed by exact source and manifest digest | MRS-002 revision list, Task-017 |
| native predicate/temporal bridge | blocked, then guaranteed by exact owner digest | quire-contract-ir #63/#64, Task-023 |
