...
| TC-036 | Parse YAML run scripts before enforcing one executable scoped ix-flow 0.0.4 package across npm install/i/add; distinguish shell comments from word-internal hashes, ignore metadata, reject alternates, and observe the manual trigger and exact runtime | Integration | P0 | NFR-003-AC-5 | ✅ implemented |
