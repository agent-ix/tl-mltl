...
| TC-076 | For W and M over every window within [0,3], every two-proposition trace up to length 5, and verdict times 0 through 2, closed-trace verdicts of the tl-syntax-lowered graph equal an independent first-occurrence direct reference for plain, constant, nested, negated, and correlated operands | Integration | P0 | FR-016-AC-1 | ✅ implemented |
