...
| TC-200 | Refuse mismatched Rust/Cargo identity and duplicate environment keys; accept exact member stable/nightly bindings | Integration | P0 | FR-055-AC-4 | ✅ implemented |
