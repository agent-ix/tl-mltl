...
fn the_sealed_records_impact_snapshot_is_the_quire_export() {
    ...
    for requirement in [
        ...
        "FR-010", "FR-016", "FR-017", "FR-018", "FR-019", "FR-020", "FR-021", "FR-022", "FR-023",
        "FR-024", "NFR-001", "NFR-002", "NFR-003", "NFR-004", "NFR-005", "StR-001", "StR-002",
        "StR-003",
    ] {
        assert!(
    ...
    // The current V1 matrix has 346 declared rows; 203 have native trace
    // backing, including the V5 mutation population's TC-183 binding and
    // the V10 FR-052-AC-2 and TC-192 per-cell replay tests.
...
fn no_local_evidence_framework_remains() {
    ...
    assert_eq!(
        inspected, 717,
        "the source census population changed from the reviewed 717 tracked files \
